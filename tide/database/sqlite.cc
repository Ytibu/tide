...
static tide::ConfigVar<std::map<std::string, std::map<std::string, std::string> > >::ptr g_sqlite3_dbs
    = tide::Config::Lookup("sqlite3.dbs", std::map<std::string, std::map<std::string, std::string> >()
            , "sqlite3 dbs");
