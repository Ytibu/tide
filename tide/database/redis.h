#ifndef TIDE_DB_REDIS_H__
#define TIDE_DB_REDIS_H__
...
namespace tide
{
    ...
    public:
        ...
        FoxRedis(tide::FoxThread *thr, const std::map<std::string, std::string> &conf);
        ~FoxRedis();
    ...
    private:
        ...
        {
            std::string cmd;
            tide::Scheduler *scheduler;
            tide::Fiber::ptr fiber;
            ReplyPtr rpy;
        };
    ...
    public:
        ...
        FoxRedisCluster(tide::FoxThread *thr, const std::map<std::string, std::string> &conf);
        ~FoxRedisCluster();
    ...
    typedef tide::Singleton<RedisManager> RedisMgr;
